...
local clientDefs = {
	...
	{ "csm_spread_layer_alloctype",           0,        true,  false },
	{ "csm_spread_layer_reservemiddle",       1,        true,  false },
	...
	{ "csm_filter",                           0.08,     true,  false },
	{ "csm_filter_distancescale",             1,        true,  false },
	{ "csm_depthresasmultiple",               0,        true,  false },
	{ "csm_depthformat",                      16,       true,  false }, -- shadow depth buffer bits: 16 or 24
	{ "csm_depthbias",                        0.000035, true,  false },
	{ "csm_depthbias_slopescale",             2,        true,  false },
	{ "csm_depthbias_distancescale",          0.0,      true,  false },
...
local serverDefs = {
	...
	{ "csm_stormfoxsupport",                0, bit.bor(FCVAR_ARCHIVE, FCVAR_REPLICATED) },
	{ "csm_stormfox_brightness_multiplier", 1, bit.bor(FCVAR_ARCHIVE, FCVAR_REPLICATED) },
	{ "csm_stormfox_coloured_sun",          0, bit.bor(FCVAR_ARCHIVE, FCVAR_REPLICATED) },
