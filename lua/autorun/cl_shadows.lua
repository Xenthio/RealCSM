...
hook.Add( "PopulateToolMenu", "CSMClient", function()
	spawnmenu.AddToolMenuOption( "Utilities", "User", "CSM_Client", "#CSM", "", "", function( panel )
		...
		combobox:AddChoice( "4: 162 samples for static props, leaf node for everything else (HL2/Real CSM Default)", 4 )
		...
		panel:ControlHelp( "Radius of the spread in degrees, real life value is 0.5, gm_construct uses an unrealistic value of 3, you should use 0.5 usually and maybe 1 for artistic purposes." )
