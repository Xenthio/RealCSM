...
function ENT:SetupDataTables()
	...
	self:NetworkVar("Float",  1, "SizeNear",       { KeyName = "Size 1" })
	self:NetworkVar("Float",  2, "SizeMid",        { KeyName = "Size 2" })
	self:NetworkVar("Float",  3, "SizeFar",        { KeyName = "Size 3" })
	self:NetworkVar("Float",  4, "SizeFurther",    { KeyName = "Size 4" })
